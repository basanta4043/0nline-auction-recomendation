...
<c:if test ="${not empty auction}">
    <div class="container">
        <div class="row">
            <a class="u-pull-left button" href="${pageContext.request.contextPath}/auction.do?action=getAnAuction&aid=${auction.auctionId}">cancel edit</a>
            <form class="u-pull-right" action="${pageContext.request.contextPath}/auction.do" method="POST">
        ...
        <form action="${pageContext.request.contextPath}/auction.do" method="POST" id="view_updateAuction">
            <div class="row">
                <label>Name</label>
