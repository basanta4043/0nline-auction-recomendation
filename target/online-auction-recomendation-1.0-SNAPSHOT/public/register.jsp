                ...
                <form action="${pageContext.request.contextPath}/user.do" method="POST" id="registerForm">
                    ...
                    <div class="row">
                        ...
                        <div class="six columns">
                            ...
                            <input class="u-full-width" type="text" id="name" name="name" minlength="2" required
                                   autofocus>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="six columns">
                            ...
                            <input class="u-full-width" type="password" id="password" name="password" minlength="3"
                                   required autofocus>
                        </div>
                        <div class="six columns">
                            <label for="repeat_password">Verify Password:</label>
                            <input class="u-full-width" type="password" id="repeat_password" name="repeat_password"
                                   equalTo="#regPassword" required autofocus>
                        </div>
                    </div>
