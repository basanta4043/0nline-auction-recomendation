...
<header class="l-full">
    <div class="c-header h-cf">
        <div class="three columns">
            <a href="${pageContext.request.contextPath}/" class="icon-home home"></a>
                        ...
                        <c:forEach var="notification" items="${notifLst}">
                            <c:if test="${notification.isSeen == 1}">
                                <p class="c-notification--seen">
                                    You have a new ${notification.type} from user ${notification.actor.username}. <a href="${pageContext.request.contextPath}/notification.do?action=viewNotification&nid=${notification.notificationId}">${notification.type} back</a>
                                </p>
                            </c:if>
        ...
        <div class="two columns">
            <div class="c-dropdown c-messages" unselectable="on">
                ...
                <div class="c-dropdown__content l-pad1">
                    <a class="icon-download c-dropdown__item" href="${pageContext.request.contextPath}/message.do?action=listInbox">Inbox</a><br />
                    <a class="icon-upload c-dropdown__item" href="${pageContext.request.contextPath}/message.do?action=listSent">Sent</a>
                </div>
            </div>
        </div>
        <div class="two columns">
            <div class="c-dropdown c-ratings" unselectable="on">
                ...
                <div class="c-dropdown__content l-pad1">
                    <a class="icon-download c-dropdown__item" href="${pageContext.request.contextPath}/rate.do?action=listFrom">Received</a><br/>
                    <a class="icon-upload c-dropdown__item" href="${pageContext.request.contextPath}/rate.do?action=listTo">Submitted</a>
                </div>
            </div>
        </div>
        <div class="two columns logout">
            <a href="${pageContext.request.contextPath}/logout.do"><span class="delete icon-power">Logout</span></a>
        </div>
    </c:if>
