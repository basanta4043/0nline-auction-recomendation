        ...
        <div class="row">
            <div class="five columns">
                ...
                <p class="small-p">
                    ...
                    <a href="${pageContext.request.contextPath}/user.do?action=getAllUsers" class="button button-primary" style="margin-top: 5px;">lists users</a>
                </p>
            </div>
            <div class="six offset-by-one columns">
                ...
                <p class="small-p">
                    ...
                    <a href="${pageContext.request.contextPath}/search.do?action=auctionsForExport" class="button button-primary" style="margin-top: 5px;">view auctions</a>
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="eleven columns">
                ...
                <div style="margin-left: 55px">
                    ...
                    <form action="${pageContext.request.contextPath}/auction.do" method="get">
