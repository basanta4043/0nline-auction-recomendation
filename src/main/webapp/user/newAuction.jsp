    ...
    <div class="row">
        <div class="column">
            <section class="register u-full-width">
                ...
                <form action="${pageContext.request.contextPath}/auction.do" method="POST" id="new_auction"
                    ...
                    <select class="a-select--multiple" id="categories" name="categories" multiple
                            size=${categoryLst.size()}>
                    ...
                    <label class="u-full-width">
                        <input type="radio" name="instantBuy" value="false"
                               onclick="document.getElementById('buyPrice').setAttribute('style','display: none')"
                               checked>
                        <span class="label-body">No. Everyone will bid for my product.</span>
                    </label>
                    <label class="u-full-width">
                        <input type="radio" name="instantBuy" value="true"
                               onclick="document.getElementById('buyPrice').setAttribute('style','display: block')">
                    ...
                    <div class="row">
                        <div class="six columns">
                            ...
                            <input class="u-full-width" type="text" id="location" name="location" minlength="2" required
                                   autofocus>
                    ...
                    <textarea form="new_auction" class="u-full-width" placeholder="a high quality product..."
                              name="description" id="description"></textarea>

                    <b>Activate the auction now?</b>
                    <label>
                        <input type="radio" name="startToday" value="false"
                               onclick="document.getElementById('activeDays').setAttribute('style','display: none')"
                               checked>No
                    </label>
                    <label>
                        <input type="radio" name="startToday" value="true"
                               onclick="document.getElementById('activeDays').setAttribute('style','display: block')">Yes
                    </label>
