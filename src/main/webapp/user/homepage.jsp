...
<div class="container">
    ...
    <div class="row">
        ...
        <form class="row" action="${pageContext.request.contextPath}/search.do" method="POST">
            <input class="seven columns" type="text" name="name">
            <button class="three columns button-primary" type="submit" name="action" value="searchAuctions">Search
            </button>
            <a class="two columns advanced" href="${pageContext.request.contextPath}/search.do?action=advancedSearch">Advanced</a>
        </form>
    </div>
    ...
    <div class="row ">
        <section class="four columns">
            ...
            <a class="button button"
               href="${pageContext.request.contextPath}/search.do?action=searchAuctions&seller=you">View all your
                auctions</a>
            <a class="button button"
               href="${pageContext.request.contextPath}/search.do?action=searchAuctions&seller=you&isActive=0">View all
                your ended auctions</a>

            <a class="button button"
               href="${pageContext.request.contextPath}/search.do?action=searchAuctions&isActive=1">Browse to all active
                auctions</a>
            <a class="button button"
               href="${pageContext.request.contextPath}/search.do?action=searchAuctions&isActive=0">Browse to all ended
                auctions</a>
        </section>
            ...
            <c:if test="${not empty recommendationLst}">
                <c:forEach var="auction" items="${recommendationLst}" varStatus="status">
                    <div class="row c-result">
                        <div class="two columns">
                            <c:if test="${not empty auction.images}">
                                <img class="img-resp"
                                     src="${pageContext.request.contextPath}/images/${auction.images.iterator().next().imageFileName}">
                            </c:if>
                    ...
                    <span class="icon-picture c-result__no-img">
                        ...
                        <div class="three columns"><a class="button button-primary"
                                                      href=${pageContext.request.contextPath}/auction.do?action=getAnAuction&aid=${auction.auctionId}>View
                            auction</a></div>
                    </div>
    ...
    <p>Please go to the <a href="${pageContext.request.contextPath}/">start page</a> and login again.</p>
    </c:if>
