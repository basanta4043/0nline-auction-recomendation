        ...
        <div class="row c-result">
            <div class="two columns">
                <c:if test="${not empty auction.images}">
                    <img class="img-resp" src="${pageContext.request.contextPath}/images/${auction.images.iterator().next().imageFileName}">
                </c:if>
            ...
            <div class="two columns">
                <c:if test="${not empty auction.categories}">
                    <c:forEach var="category" items="${auction.categories}">
                        <a href="https://localhost:8080/online-auction/search.do?action=searchAuctions&categories=${category.categoryId}&reallyActive=true"
            ...
            <div class="two columns"><a class="button button-primary" href=${pageContext.request.contextPath}/auction.do?action=getAnAuction&aid=${auction.auctionId}>View auction</a></div>
        </div>
