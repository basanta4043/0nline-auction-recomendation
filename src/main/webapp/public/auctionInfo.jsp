...
<head>
    ...
    <jsp:useBean id="auction" class="com.online.auction.onlineauctionrecomendation.model.AuctionEntity" scope="request" />
    ...
    <jsp:useBean id="seller" class="com.online.auction.onlineauctionrecomendation.model.UserEntity" scope="request"/>
    ...
    <div class="container">
        ...
        <c:if test="${auction.isActive == 0 and not isEnded and isSeller}" >
            ...
            <div class="js-date row">
                <form action="${pageContext.request.contextPath}/auction.do" method="post" class="four columns u-no-bottom form-changeDate" >
        ...
        <c:if test="${isSeller and not isEnded and empty bidLst}">
            <a class="js-make-writable button" href="${pageContext.request.contextPath}/auction.do?action=editAuction&aid=${auction.auctionId}">edit auction</a>
        </c:if>
            ...
            <div class="">
                ...
                <c:if test="${not isSeller and not empty user.userId and auction.buyPrice > 0}">
                    <c:if test="${not empty bidLst}">
                        ...
                        <form action="${pageContext.request.contextPath}/auction.do" method="post">
        ...
        <div class="container">
            ...
            <c:if test="${not empty bidLst}">
                ...
                <c:if test="${user.userId == biddersLst[0].userId}">
                    ...
                    <a class="button" href="${pageContext.request.contextPath}/message.do?action=getConversation&rid=${auction.sellerId}&aid=${auction.auctionId}">Contact the seller</a>
                    <a class="button" href="${pageContext.request.contextPath}/rate.do?action=getRating&to_id=${auction.sellerId}&aid=${auction.auctionId}">Rate the seller</a>
                </c:if>
                ...
                <c:if test="${isSeller}">
                    ...
                    <a class="button" href="${pageContext.request.contextPath}/message.do?action=getConversation&rid=${auction.buyerId}&aid=${auction.auctionId}">Contact the buyer</a>
                    <a class="button" href="${pageContext.request.contextPath}/rate.do?action=getRating&to_id=${auction.buyerId}&aid=${auction.auctionId}">Rate the buyer</a>
                </c:if>
            </c:if>
            <c:if test="${empty bidLst}">
        ...
        <div class="container">
            <c:if test="${not empty bidLst}">
                ...
                <c:if test="${not isSeller and not empty user.userId}">
                    <form action="${pageContext.request.contextPath}/auction.do" method="post" class="js-confirm-bid">
