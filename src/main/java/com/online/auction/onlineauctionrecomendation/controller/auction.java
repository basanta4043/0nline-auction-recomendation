...
import com.online.auction.onlineauctionrecomendation.model.*;
import com.online.auction.onlineauctionrecomendation.service.AuctionService;
import com.online.auction.onlineauctionrecomendation.service.CategoryService;
...
import com.online.auction.onlineauctionrecomendation.util.CategoryXmlUtil;
import com.online.auction.onlineauctionrecomendation.util.UserXmlUtil;
...
@WebServlet(name = "auction", urlPatterns = "/auction.do")
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (request.getParameter("action")) {
            ...
            case "activateAuction":
                ...
                response.sendRedirect("/online-auction/auction.do?action=getAnAuction&aid=" + aid + "&from=activate&status=" + status);
                return;
            case "updateAuction":
                status = false;
                ...
                response.sendRedirect("/online-auction/auction.do?action=getAnAuction&aid=" + aid + "&from=update&status=" + status);
                return;
            case "deleteAuction":
                try {
                    aid = Long.parseLong(request.getParameter("aid"));
            ...
            case "bidAuction":
                ...
                response.sendRedirect("/online-auction/auction.do?action=getAnAuction&aid=" + aid + "&from=bid&status=" + status);
                return;
            case "buyAuction":
                aid = Long.parseLong(request.getParameter("aid"));
                session = request.getSession();
            ...
            case "getAuctionsAsXML":
                ...
                stream.addDefaultImplementation(org.hibernate.collection.internal.PersistentList.class, List.class);
                stream.addDefaultImplementation(org.hibernate.collection.internal.PersistentMap.class, Map.class);
                stream.addDefaultImplementation(org.hibernate.collection.internal.PersistentSet.class, Set.class);
